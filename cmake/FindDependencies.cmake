...
if(NOT SQLite3_FOUND)
    if(EXISTS "${CMAKE_SOURCE_DIR}/vendor/sqlite")
        message(STATUS "Using vendored SQLite")
        set(SQLITE_INCLUDE_DIR "${CMAKE_SOURCE_DIR}/vendor/sqlite")
        set(SQLITE_LIBRARIES "${CMAKE_SOURCE_DIR}/vendor/sqlite/sqlite3${CMAKE_STATIC_LIBRARY_SUFFIX}")
    else()
        message(FATAL_ERROR "SQLite3 not found. Install SQLite or add to vendor/")
    endif()
else()
